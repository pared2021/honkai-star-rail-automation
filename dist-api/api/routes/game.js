...
router.get('/third-party-tools', async (req, res) => {
    try {
...
router.get('/filter-report', async (req, res) => {
    try {
...
router.get('/injection/:processId', async (req, res) => {
    try {
...
router.get('/driver-filters', async (req, res) => {
    try {
...
router.post('/can-launch', async (req, res) => {
    try {
        const config = {
            ...req.body,
            id: req.body.id || undefined,
...
router.get('/detect-installation', async (req, res) => {
    try {
...
router.get('/recommended-config/:gamePath', async (req, res) => {
    try {
...
router.post('/auto-launch/check', async (req, res) => {
    try {
...
router.post('/auto-launch/execute', async (req, res) => {
    try {
        const settings = req.body;
...
router.post('/emergency-stop', async (req, res) => {
    try {
        ...
        const runningTasks = [];
        const stopPromises = runningTasks.map(task => Promise.resolve({ success: true }));
