...
class TestTaskPriority(unittest.TestCase):
    ...
    def test_priority_ordering(self):
        ...
        expected = [TaskPriority.URGENT, TaskPriority.HIGH, TaskPriority.MEDIUM, TaskPriority.LOW]
...
class TestTaskManager(unittest.TestCase):
    ...
    def test_create_task_with_different_priorities(self):
        ...
        self.assertEqual(self.task_manager._stats["total_tasks"], len(priorities))
    ...
    def test_get_task_active(self):
        ...
        task_info = self.task_manager.get_task("test_task")
