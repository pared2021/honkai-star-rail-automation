...
class TestSyncAdapter:
    ...
    def test_start_adapter(self):
        """测试启动适配器"""
        with patch.object(self.adapter, '_start_event_loop') as mock_start_loop, \
             patch.object(self.adapter, '_start_callback_thread') as mock_start_callback:
    ...
    def test_stop_adapter(self):
        ...
        with patch.object(self.adapter, '_stop_event_loop') as mock_stop_loop, \
             patch.object(self.adapter, '_stop_callback_thread') as mock_stop_callback:
