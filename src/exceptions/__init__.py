...
class TaskNotFoundError(TaskError):
    ...
    def __init__(self, task_id: str, original_error: Optional[Exception] = None):
        super().__init__(
            f"Task not found: {task_id}", "TASK_NOT_FOUND", task_id, original_error
        )
...
class ServiceShutdownError(ServiceError):
    ...
    def __init__(
        ...
        super().__init__(
            message, "SERVICE_SHUTDOWN_ERROR", service_name, original_error
        )
...
class ServiceOperationError(ServiceError):
    ...
    def __init__(
        ...
        super().__init__(
            message, "SERVICE_OPERATION_ERROR", service_name, original_error, context
        )
...
class ServiceTimeoutError(ServiceError):
    ...
    def __init__(
        ...
        super().__init__(
            message, "SERVICE_TIMEOUT_ERROR", service_name, original_error, context
        )
...
class EventHandlerError(EventError):
    ...
    def __init__(
        ...
        super().__init__(
            message, "EVENT_HANDLER_ERROR", event_type, original_error, context
        )
...
class SyncAdapterError(BaseApplicationError):
    ...
    def __init__(
        self,
        message: str,
        error_code: str = "SYNC_ADAPTER_ERROR",
        original_error: Optional[Exception] = None,
    ):
        super().__init__(message, error_code, original_error)
