...
const mockPsList = psList as jest.MockedFunction<typeof psList>;
...
describe('GameDetector', () => {
  ...
  beforeEach(() => {
    ...
    (gameDetector as any).log = mockLogger;
  });
  ...
  describe('Process Detection', () => {
    it('should detect game process when running', async () => {
      ...
      mockPsList.mockResolvedValue(mockProcesses as any);
      
      const processInfo = await (gameDetector as any).detectGameProcess();
    ...
    it('should handle process detection errors', async () => {
      ...
      await expect((gameDetector as any).detectGameProcess()).rejects.toThrow('Process list failed');
  ...
  describe('Window Detection', () => {
    it('should detect game window when available', async () => {
      ...
      mockWindowManager.getWindows.mockReturnValue(mockWindows as any);
      
      const windowInfo = await (gameDetector as any).getGameWindow();
  ...
  describe('Active Window Detection', () => {
    it('should detect when game window is active', async () => {
      ...
      const isActive = await (gameDetector as any).isGameWindowActive();
  ...
  describe('Game Status Detection', () => {
    it('should detect game as running when process and window exist', async () => {
      ...
      await (gameDetector as any).detectGameStatus();
  ...
  describe('Event Emission', () => {
    it('should emit gameStarted event when game starts', (done) => {
      ...
      (gameDetector as any).detectGameStatus();
    });
    ...
    it('should emit gameStopped event when game stops', (done) => {
      ...
      (gameDetector as any).detectGameStatus().then(() => {
        ...
        return (gameDetector as any).detectGameStatus();
      }).catch(done);
    });
  });
