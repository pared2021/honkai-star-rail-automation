...
from src.ui.mvp.task_list_mvp import TaskListMVP
...
class MainWindowPresenter(BasePresenter):
    ...
    def __init__(
        ...
        self.task_list_mvp = TaskListMVP(
            task_service=task_service, sync_adapter=sync_adapter
        )
    ...
    def setup_connections(self):
        ...
        if hasattr(self.automation_controller, "status_changed"):
            self.automation_controller.status_changed.connect(
                self.on_automation_status_changed
            )
    ...
    def update_view_from_model(self):
        ...
        try:
            ...
            view_data = {
                ...
                "system_status": model_data.get("system_info", {}).get(
    ...
    def on_alert_triggered(self, level: str, message: str, data: dict):
        ...
        try:
            ...
            if level in ["critical", "error"]:
                ...
                current_status = self.model.get_data("system_info", {}).get(
                    "health_status", "good"
                )
