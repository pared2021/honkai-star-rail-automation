...
from PyQt6.QtWidgets import (
    ...
    QLabel, QPushButton, QTextEdit, QTabWidget, QMenuBar, QMenu,
    QStatusBar, QToolBar, QSplitter, QGroupBox, QFrame,
...
class MainWindowView(QMainWindow, BaseView):
    ...
    def update_task_statistics(self, stats: Dict[str, Any]):
        ...
        if self.completed_tasks_metric:
            self.completed_tasks_metric.update_value(str(stats.get('completed', 0)), "个")
