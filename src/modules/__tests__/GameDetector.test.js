...
const mockActiveWin = require('active-win');
const mockPsList = require('ps-list');
describe('GameDetector', () => {
    ...
    describe('startDetection and stopDetection', () => {
        ...
        it('should not start detection multiple times', () => {
            gameDetector.startDetection();
            const firstInterval = gameDetector.detectionInterval;
            gameDetector.startDetection();
            const secondInterval = gameDetector.detectionInterval;
