...
export class InputController {
    constructor() {
        ...
        Object.defineProperty(this, "gameWindow", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "inputLogs", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        ...
        Object.defineProperty(this, "safetyChecks", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: true
        });
        Object.defineProperty(this, "lastActionTime", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        });
        Object.defineProperty(this, "minActionInterval", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 10
    ...
    async click(x, y, options = {}) {
        ...
        try {
            const { button = 'left', double = false, delay = this.defaultDelay } = options;
            // 转换坐标（如果设置了游戏窗口）
    ...
    async pressKey(key, options = {}) {
        ...
        try {
            const { modifiers = [], delay = this.defaultDelay } = options;
            // 验证按键名称
     ...
     * 滚轮滚动
     */
    async scroll(x, y, direction, clicks = 3) {
        if (!this.isEnabled) {
     ...
     * 平滑移动鼠标
     */
    async smoothMoveTo(from, to, duration = 500) {
     ...
     * 记录操作日志
     */
    logAction(action, coordinates, success = true, details) {
        const log = {
            timestamp: Date.now(),
            action,
            coordinates,
     ...
     * 组合键操作
     */
    async keyCombo(keys, holdTime = 100) {
        if (!this.isEnabled) {
