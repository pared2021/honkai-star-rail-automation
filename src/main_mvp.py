...
from src.gui.common.gui_components import QApplication, QIcon, Qt
...
from src.ui.main_window import MainWindowModel, MainWindowPresenter, MainWindowView
...
def initialize_services(config_manager: ConfigManager, db_manager: DatabaseManager):
    ...
    automation_controller = AutomationController(
        config_manager, db_manager, game_detector
    )
...
def main():
    ...
    try:
        ...
        # 初始化服务层
        task_service, automation_service = initialize_services(
