...
class ErrorRecoveryConfig:
    ...
    def get_strategies_by_severity(
    ...
    def get_strategies_by_priority(
        ...
        return sorted(
            [
                strategy
                for strategy in self.strategies.values()
                if strategy.priority >= min_priority
            ],
    ...
    def export_config(self) -> Dict[str, Any]:
        ...
        return {
            error_type: {
                ...
                "retry_triggers": [
                    trigger.value for trigger in strategy.retry_triggers
                ],
    ...
    def get_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "retry_enabled_percentage": (
                (retry_enabled_count / total_strategies * 100)
