...
class AlertManager(QObject):
    ...
    def __init__(self, event_bus: EventBus, notification_config: NotificationConfig = None):
        super().__init__()
    ...
    def create_alert(self, rule_id: str, title: str, message: str, 
                    ...
                    tags: Dict[str, str] = None) -> Optional[Alert]:
        """创建告警"""
    ...
    def get_alerts(self, limit: Optional[int] = None, status: Optional[AlertStatus] = None) -> List[Alert]:
        """获取告警列表"""
        with self.data_lock:
