...
class TestMonitoringSystemIntegration:
    ...
    def test_monitoring_system_start_stop(self):
        ...
        self.mock_event_bus.emit.assert_called_with(
            "monitoring_system_started", unittest.mock.ANY
        )
    ...
    def test_component_integration(self):
        ...
        self.monitoring_system.logging_service.add_log_entry(
            level=LogLevel.ERROR, message="测试错误日志", module="test_component"
        )
    ...
    def test_alert_integration(self):
        ...
        # 添加告警规则
        from src.monitoring.alert_manager import AlertChannel, AlertRule
        ...
        # 验证规则已添加
        assert (
            self.monitoring_system.alert_manager.get_rule("cpu_alert_rule") is not None
        )
    ...
    def test_health_check_integration(self):
        ...
        # 获取健康状态
        overall_status = (
            self.monitoring_system.health_checker.get_overall_health_status()
        )
    ...
    def test_config_management_integration(self):
        ...
        success = self.monitoring_system.update_config(ConfigType.ALERTING, new_config)
        assert success == True
    ...
    def test_error_handling(self):
        ...
        success = self.monitoring_system.config_manager.update_config(
            ConfigType.MONITORING, invalid_config
        )
        # 配置管理器应该处理无效数据
    ...
    def test_performance_under_load(self):
        ...
        for i in range(100):
            self.monitoring_system.logging_service.add_log_entry(
                level=LogLevel.INFO, message=f"测试日志 {i}", module="performance_test"
            )
