...
class TestDatabaseManager(unittest.TestCase):
    ...
    def test_task_operations(self):
        ...
        self.db_manager.create_user(
            user_id=user_id, username="任务测试用户", email="tasktest@example.com"
        )
    ...
    def test_execution_log(self):
        ...
        self.db_manager.create_user(
            user_id=user_id, username="日志测试用户", email="logtest@example.com"
        )
    ...
    def test_user_config(self):
        ...
        # 创建用户
        self.db_manager.create_user(
            user_id=user_id, username="配置测试用户", email="configtest@example.com"
        )
