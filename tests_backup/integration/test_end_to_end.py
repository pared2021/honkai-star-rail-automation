...
from src.core.task_executor import TaskExecutor, ExecutorStatus, TaskExecutionContext, RetryPolicy
...
class TestEndToEnd:
    ...
    async def test_complete_automation_workflow(self, setup_complete_system):
        ...
        with patch.object(automation_service, 'detect_game_window') as mock_detect, \
             ...
             patch.object(automation_service, 'execute_automation_sequence') as mock_sequence:
    ...
    async def test_error_handling_and_recovery(self, setup_complete_system):
        ...
        with patch.object(automation_service, 'detect_game_window', side_effect=mock_failing_operation):
    ...
    async def test_data_consistency_across_operations(self, setup_complete_system):
        ...
        # 模拟截图操作
        with patch.object(system['automation_service'], 'take_screenshot') as mock_screenshot:
